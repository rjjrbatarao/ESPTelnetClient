...
ESPtelnetClient::ESPtelnetClient(SyncClient& client){
	this->client = &client;	
}

bool ESPtelnetClient::login(const IPAddress& serverIpAddress, const char* username, const char* password, uint8_t port){
